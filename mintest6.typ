...
= Resultados
== Presentación
Los datos relevados muestran una tendencia, ver #ref(<fig-tendencia>, supplement: [Figura]).
...
== Analisis
Los resultados, en linea con Castel (#cite(<castel1997>, form: "year")):

#quote(block: true)[
La cuestion social es una aporia. @castel1997[p.~20]
]

== Discusion
=== Comparacion
Texto de comparacion.

=== Implicaciones
Texto de implicaciones.
